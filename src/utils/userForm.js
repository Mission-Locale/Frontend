export const STEPS = [
  {
    ...
    subTitle:
      "Entrez vos informations dans les champs requis",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "Prenez rendez-vous immédiatement avec un conseiller pour finaliser votre inscription.",
    mainTitle: "Prendre rendez-vous",
    subTitle:
      "Choisissez une date pour votre rendez-vous avec un conseiller."
  },
];