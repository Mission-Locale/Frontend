...
export const hoverBg = {
  brandBlue: "hover:bg-brandBlue/90",
  brandOrange: "hover:bg-brandOrange/90",
  brandGreen: "hover:bg-brandGreen/90",
  brandPink: "hover:bg-brandPink/90",
  brandPurple: "hover:bg-brandPurple/90",
};

// RING COLORS

export const ring = {
  brandOrange: "focus:ring-brandOrange",
  brandBlue: "focus:ring-brandBlue",
  brandGreen: "focus:ring-brandGreen",
  brandPink: "focus:ring-brandPink",
